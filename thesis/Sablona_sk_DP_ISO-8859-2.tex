...
\authorGN{Doplòte Va¹e krstné meno/mená} %(krstné) meno (mená) autora
\authorFN{Doplòte Va¹e priezvisko} % priezvisko autora
\authorWithDegrees{Doplòte Va¹e meno a tituly} %meno autora vèetne súèasných akademických titulov
\author{Jan Nový} %meno autora bez súèasných akademických titulov
...
\abstractCS{V niekoµkých vetách zhròte obsah a prínos tejto práce v~slovenèine. Po preèítaní abstraktu by mal èitateµ ma» dos» informácií pre rozhodnutie, èi Va¹u prácu chce èíta».}
\abstractEN{Sem doplòte ekvivalent abstraktu Va¹ej práce v~angliètinì.}
\placeForDeclarationOfAuthenticity{V~Prahe}
\declarationOfAuthenticityOption{1} %voµba Prehlásenia (èíslo 1-6)
\keywordsCS{Nahraïte zoznamom kµúèových slov v slovenèine oddelených èiarkou.}
\keywordsEN{Nahraïte zoznamom kµúèových slov v angliètine oddelených èiarkou.}
% \website{http://site.example/thesis} %volitelná URL práce, objeví se v tirá¾i
...
\begin{figure}
	\dirtree{%
		...
		.1 exe\DTcomment{adresár so spustiteµnou formou implementácie}.
		.1 src.
