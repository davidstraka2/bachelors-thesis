...
Funkčnost rozšíření byla řádně otestována s využitím jednotkových testů, integračních testů a jednoduchého uživatelského
...
použité permisivní open-source licenci a kódu dostupnému na portálu GitHub\footnote{GitHub: Wootom (\url
{https://github.com/davidstraka2/wootom})}.
